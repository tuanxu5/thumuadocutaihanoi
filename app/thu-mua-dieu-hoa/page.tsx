            ...
            {[
              ...
              >
                ...
                <div className="absolute top-2 right-2 bg-[#155C8A] text-white px-2 py-1 rounded text-xs md:text-sm font-bold shadow-lg flex items-center gap-1">
                  ...
                  <span className="">0919.562.568</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/tin-tuc" className="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-[#155C8A] transition-colors">
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg mb-2">Quy Trình Thu Mua Điều Hòa Chuyên Nghiệp</h3>
                <p className="text-gray-600 text-sm line-clamp-2">Tìm hiểu quy trình thu mua điều hòa chuyên nghiệp của chúng tôi...</p>
              </div>
            </Link>
          </div>
        </div>
